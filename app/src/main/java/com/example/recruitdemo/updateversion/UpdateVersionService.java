...
//		String url = versionInfo.getDownloadUrl();
		...
		String url="http://223.72.255.100/MOA/static/apk/moa.apk";
	...
	public void downLoadFile(String url){
		File file = new File(updateFile.getAbsolutePath());
		if (file.exists()){
			file.delete();
		}
...
//                notification.contentView.setViewVisibility(R.id.btnCancel,View.GONE);
			...
			public void onFailure(HttpException error, String msg) {
				...
				if(error.getExceptionCode() == 0 ){
					...
					// 更改文字
	                notification.contentView.setTextViewText(R.id.msg, "Moa");
	                // 更改文字
			...
			public void onLoading(long total, long current, boolean isUploading) {
				...
				notification.contentView.setTextViewText(R.id.msg, "正在下载：Moa");
				// 更改文字
...
//				notification.contentView.setOnClickPendingIntent(R.id.btnStartStop, pendingIntent);
			...
			@Override
			public void onStart() {
				notification.contentView.setTextViewText(R.id.msg, "开始下载：Moa");
				nm.notify(titleId, notification);
			}
